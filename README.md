# interactive_rangers-top-prospects-2019
...
`gulp publish` will upload your [`dist/`](dist/) folder to the `2019/rangers-top-prospects-2019/` folder on our interactives S3 bucket.
